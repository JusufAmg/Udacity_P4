...
void TrafficLight::togglePhase() {
    if(this->_currentPhase==green) this->_currentPhase = red;
    else this->_currentPhase==green;
}
...
void TrafficLight::cycleThroughPhases()
{
    ...
    while(true) {
        ...
        if (duration >= cycle_duration) {
            ...
            ftr = std::async(std::launch::async,&MessageQueue<TrafficLightPhase>::send,&_queue,std::move(_currentPhase));
            ftr.wait();
